-- Create pending_subscriptions table to store subscription data before payment
-- This prevents abandoned subscriptions from being created in user_subscriptions
...
CREATE TABLE IF NOT EXISTS pending_subscriptions (
  ...
  variant_amount NUMERIC(10, 2), -- Store variant price in rupees
...
CREATE INDEX IF NOT EXISTS idx_pending_subscriptions_razorpay_id 
