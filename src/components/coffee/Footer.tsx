...
export default function Footer() {
  ...
  return (
    <footer className="bg-coffee-dark text-white relative overflow-hidden">
      {/* Background Pattern */}
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1 relative">
                <Input
                  ...
                  className="h-14 bg-white/10 border-white/20 text-white placeholder:text-white/40 focus:border-coffee-gold focus:ring-coffee-gold/20 pr-12"
                  required
                />
              ...
              <Button 
                type="submit" 
                disabled={isLoading}
                className="h-14 px-8 bg-coffee-gold hover:bg-coffee-gold/90 text-coffee-dark font-semibold group"
              >
                Subscribe
      ...
      <div className="relative border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {[
              { icon: Coffee, title: 'Estate Fresh', desc: 'Direct from Coorg' },
              { icon: Leaf, title: '100% Natural', desc: 'No artificial additives' },
              { icon: Award, title: 'Since 1983', desc: 'Four decades of trust' },
              { icon: Heart, title: 'Made with Love', desc: 'Handcrafted blends' },
            ].map((badge) => (
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  key={social.label}
                  href={social.href}
                  className="w-10 h-10 bg-white/10 hover:bg-coffee-gold hover:text-coffee-dark transition-all duration-300 rounded-full flex items-center justify-center group"
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              {[
                ...
                { name: 'Filter Coffee', link: '/shop/gold-blend' },
                { name: 'Specialty Blends', link: '/shop/specialty-blends' },
                { name: 'Royal Caffeine', link: '/shop/royal-caffeine' },
                { name: 'Instant Coffee', link: '/shop/instant-coffee-decoctions' },
              ].map((item) => (
                <li key={item.name}>
                  <Link
                    to={item.link}
                    className="text-white/60 hover:text-coffee-gold transition-colors text-sm inline-flex items-center gap-2 group"
                  >
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-sm text-white/60">
                ...
                <span>Sharma Coffee Estate, Madikeri, Coorg, Karnataka 571201</span>
              </li>
              <li>
                <a href="tel:+919876543210" className="flex items-center gap-3 text-sm text-white/60 hover:text-coffee-gold transition-colors">
                  <Phone className="w-4 h-4 text-coffee-gold flex-shrink-0" />
                  +91 98765 43210
                </a>
              </li>
              <li>
                <a href="mailto:hello@sharmacoffee.com" className="flex items-center gap-3 text-sm text-white/60 hover:text-coffee-gold transition-colors">
                  <Mail className="w-4 h-4 text-coffee-gold flex-shrink-0" />
